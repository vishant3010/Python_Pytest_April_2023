...
def test_merchant_mapping():
    ...
    driver.find_element(By.XPATH, "//input[@id='idmerchantid+356']").send_keys("79319575")
    driver.find_element(By.XPATH, "//input[@id='idpassword+356']").send_keys("testpassword_bfMifHXUY53euN0dAJLN2TBtl4B391yH5KoFwnP3W8VeB")
